  ...
  return info ? (
    <div className=" text-white bg-[#1F1E24]">
      ...
      >
          ...
          <div className="middle-right flex flex-col gap-5 mt-5">
            ...
            <div className="flex gap-5 items-center text-white text-xl font-semibold">
              ...
              <span className="font-semibold">
                ...
                {info.detail.release_date.slice(0, 4)}
              </span>{" "}
              {/*Duration*/}
              <span className="font-semibold">
                <span className="text-[#6556CD] ">Duration : </span>
                {(info.detail.runtime / 60).toFixed()}h{" "}
                {(info.detail.runtime % 60).toFixed()}min
              </span>{" "}
            </div>
        ...
        {/*CTA Div Bottom Div*/}
        <div className="bottom mt-10 ml-[10%] pb-20">
      ...
      {/* Recommended Movies === Agar Recommended hai to vo dikhao nhi to similar movies dikha do*/}
      {/* Recommendation ya similar dono me se koi ek bhi available raha to div show hoga */}
